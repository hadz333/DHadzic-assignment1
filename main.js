...
function Plumbus(game, spritesheet) {
    this.animation = new Animation(spritesheet, 0, 0, 480, 480, 0.05, 0, true);
    this.x = -400;
    this.y = 100;
    this.speed = 5;
    this.game = game;
...
AM.queueDownload("./img/fever.png");
